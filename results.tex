...
\begin{figure*}[!htb]
	\vspace{2mm}
\centerline{%
	\subfigure[Crossing: constant distance from camera, target often occluded.]{\includegraphics[width=0.24\linewidth]{imgs/comparison/occ1.png}
			   \includegraphics[width=0.24\linewidth]{imgs/comparison/occ2.png}
			   \includegraphics[width=0.24\linewidth]{imgs/comparison/occ3.png}
			   \includegraphics[width=0.24\linewidth]{imgs/comparison/occ4.png}}
			   \label{fig:crossing}}
	\vspace{-2mm}
\centerline{%
	\subfigure[Jumping: high motion blur.]{\includegraphics[width=0.24\linewidth,trim={0, 0 0 2cm},clip]{imgs/comparison/blur1.png}
	           ...
	           \label{fig:jumping}}
	           \centerline{%
\subfigure[Skating: motion blur, scale and light change.]{\includegraphics[width=0.24\linewidth]{imgs/comparison/skating1.png}
