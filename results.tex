...
\begin{figure*}[!htb]
	\vspace{2mm}
\centerline{%
	\subfigure{\includegraphics[width=0.24\linewidth]{imgs/comparison/occ1.png}}
	\subfigure{\includegraphics[width=0.24\linewidth]{imgs/comparison/occ2.png}}
	\subfigure{\includegraphics[width=0.24\linewidth]{imgs/comparison/occ3.png}}
	\subfigure{\includegraphics[width=0.24\linewidth]{imgs/comparison/occ4.png}}}
	\vspace{-2mm}
\centerline{%
	\subfigure{\includegraphics[width=0.24\linewidth]{imgs/comparison/car1.png}}
	\subfigure{\includegraphics[width=0.24\linewidth]{imgs/comparison/car2.png}}
	\subfigure{\includegraphics[width=0.24\linewidth]{imgs/comparison/car3.png}}
	\subfigure{\includegraphics[width=0.24\linewidth]{imgs/comparison/car4.png}}}
